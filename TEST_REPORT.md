# TEST_REPORT — sindagi-dhanvantari-nursing-home

- `npm install`: PASS (87 packages)
- `npm run build`: PASS — `dist/index.html` 16.46 kB (gzip 4.08 kB), CSS 12.05 kB (gzip 3.27 kB), JS 1.20 kB (gzip 0.63 kB). Total `dist/` ≈ 40K.
- Base path: `/sindagi-dhanvantari-nursing-home/` ✓
...
- SEO: title + meta description + OG tags ✓; JSON-LD `Hospital` (no `telephone`) ✓
